...
const Privacy = (props) => {
    return (
        <main className="privacy flex flex-col dark:text-white text-black relative overflow-hidden"  >
            <Head>
                <title>privacy policy</title>
                <link rel="icon" href="/favicon.ico" />
            </Head>

            <p className="text-2xl"><span>We receive from your device and store on our servers the following data:</span></p>
            <ul>
            ...
            <p className="text-2xl"><span>What data can be obtained:</span></p>
            <ul>
                <li><span>-Time intervals</span></li>
                <li><span>-Name</span></li>
            </ul>

            <h1 className="text-2xl"><span>How data is used</span></h1>
            ...
            <p><span>-Data transfer to third parties.</span></p>
            ...
            <h1 className="text-2xl"><span>Shelf life</span></h1>
            ...
            <p><span><strong>Last updated: 30 July 2022</strong></span></p>
        </main>
    )
}
